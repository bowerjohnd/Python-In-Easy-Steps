...
# Features that differ from the book:
#	- Added color changes to disabled buttons
#	- Sorted the numbers before displaying
# tkinter colors
...
getBtn.configure(text = "Get My Lucky Numbers", bg = "green1")
resBtn.configure(text = "Reset", bg = "gray70")
...
def pick() :
	...
	getBtn.configure(state = DISABLED, bg = "gray70")
	resBtn.configure(state = NORMAL, bg = "green1")
...
def reset() :
	...
	label5.configure(text = "...")
	label6.configure(text = "...")
	getBtn.configure(state = NORMAL, bg = "green1")
	resBtn.configure(state = DISABLED, bg = "gray70")
